...
function Layout() {
  ...
  const isAuthorized = () => {
    ...
    const authorizedPaths: Record<string, string[]> = {
      'Admin': ['course', 'student', 'rate', 'enrollment1', 'enrollment2', 'enrollment3', 'ratecourse', '/', 'grades', 'profile', 'application', 'statement-of-account', 'users', 'subject-prerequisite', 'schedules', 'routes', 'AY', 'grant-permission', 'professors', 'highschool', 'elementary', 'town', 'enroll-description'],
